...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: '300', color: '#1E3A8A', fontFamily: 'Georgia' },
  addButton: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#D4AF37', alignItems: 'center', justifyContent: 'center' },
  section: { marginBottom: 32 },
  sectionTitle: { fontSize: 14, fontWeight: '600', color: '#5A5A5A', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 12 },
  bookCard: { backgroundColor: '#F9FAFB', borderRadius: 8, padding: 16, flexDirection: 'row', alignItems: 'center', marginBottom: 8, borderWidth: 1, borderColor: '#D9D0C3', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 12, elevation: 4 },
  ...
  progressBar: { flex: 1, height: 4, backgroundColor: '#D9D0C3', borderRadius: 2, overflow: 'hidden' },
  progressFill: { height: '100%', backgroundColor: '#D4AF37' },
  progressText: { fontSize: 12, color: '#5A5A5A', width: 36 },
  deleteButton: { padding: 8, marginLeft: 8 },
  emptyState: { alignItems: 'center', padding: 40 },
  emptyEmoji: { fontSize: 64, marginBottom: 16 },
  emptyTitle: { fontSize: 20, fontWeight: '600', color: '#1E3A8A', marginBottom: 8 },
  emptyText: { fontSize: 14, color: '#5A5A5A', textAlign: 'center' },
